...
const FaqScreen = () => {
  ...
  return (
    <div className='faq-accordion'>
      <h1 className='page-opop'>Frequently Asked Questions</h1>
      <div className='faq-accordion__container'>
        <Fragment>
          <div className='faq-accordion__wrap' onClick={() => toggle(1)}>
            <h1>Can you deliver at a specific time?</h1>
            <span>
              {clicked === 1 ? (
        ...
        <Fragment>
          <div className='faq-accordion__wrap' onClick={() => toggle(2)}>
            <h1>Will my order be delivered today?</h1>
            <span>
              {clicked === 2 ? (
                <FiMinus className='faq-accordion__icon' />
              ) : (
        ...
        <Fragment>
          <div className='faq-accordion__wrap' onClick={() => toggle(3)}>
            <h1>What if my recipient isn't home when delivery is made?</h1>
            <span>
              {clicked === 3 ? (
                <FiMinus className='faq-accordion__icon' />
              ) : (
        ...
        <Fragment>
          <div className='faq-accordion__wrap' onClick={() => toggle(4)}>
            <h1>Can you deliver to a gated community?</h1>
            <span>
              {clicked === 4 ? (
                <FiMinus className='faq-accordion__icon' />
              ) : (
        ...
        <Fragment>
          <div className='faq-accordion__wrap' onClick={() => toggle(5)}>
            <h1>How will I know once my order has been delivered?</h1>
            <span>
              {clicked === 5 ? (
                <FiMinus className='faq-accordion__icon' />
              ) : (
          ...
          {clicked === 5 ? (
            <div className='faq-accordion__dropdown'>
              <p>
                ...
                egestas mollis varius; dignissim elementum. Lorem ipsum odor
                amet, consectetuer adipiscing elit. Ac purus in massa egestas
                mollis varius; dignissim elementum.
              </p>
            </div>
          ) : null}
        </Fragment>
